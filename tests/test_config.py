...
class TestLoadConfig:
    ...
    def test_load_missing_pyproject(self):
    ...
    def test_load_no_tool_section(self):
...
class TestFilterDiagnostics:
    def _make_diag(self, severity: str = "error", rule: str = "shape-mismatch") -> Diagnostic:
        return Diagnostic(
            file="test.py", line=1, col=0, severity=severity, message="test", rule=rule
        )

    def test_default_severity_shows_only_errors(self):
    ...
    def test_severity_info_shows_all(self):
    ...
    def test_filter_by_ignore_rules(self):
